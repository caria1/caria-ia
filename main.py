...
# Garante que a pasta 'backend' seja importável
...
# Importações e Registro de Rotas
try:
    ...
    logger.info("Roteadores registrados.")
except Exception as e:
    logger.error(f"Erro ao carregar módulos do backend: {e}")
